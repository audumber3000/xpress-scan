...
def delete_file_from_supabase(filename: str, bucket_name: str = "xpress-scan-bucket") -> bool:
    ...
    """
    from domains.infrastructure.services.r2_storage import delete_file_from_r2
...
def list_files_in_bucket(bucket_name: str = "xpress-scan-bucket") -> list:
    ...
    """
    from domains.infrastructure.services.r2_storage import list_files_in_folder
...
def create_bucket_if_not_exists(bucket_name: str = "xpress-scan-bucket") -> bool:
    ...
    """
    from domains.infrastructure.services.r2_storage import create_bucket_if_not_exists as r2_create_bucket
