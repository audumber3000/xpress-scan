...
from domains.infrastructure.services.sync_service import sync_all_tables, sync_table, get_last_sync_time
...
async def get_sync_status(
    ...
    from domains.infrastructure.services.sync_service import SYNC_TABLES
