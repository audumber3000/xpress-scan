            ...
            {teethData[selectedTooth] && (
              <div className="space-y-3">
                <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  ...
                  <span className="px-3 py-1 bg-[#9B8CFF]/20 text-[#2a276e] rounded-full text-sm font-semibold">
                  ...
                  <div className="p-3 bg-gray-50 rounded-lg">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {Object.entries(teethData[selectedTooth].surfaces).map(([surface, condition]) => (
                        <span
                          key={surface}
                          className="px-3 py-1 bg-[#9B8CFF]/20 text-[#2a276e] rounded-full text-sm font-semibold"
                        >
