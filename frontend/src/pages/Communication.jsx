      ...
      <div>
        {activeTab === "whatsapp" && (
          <div>
                ...
                >
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                    <button
                      ...
                      className="text-sm text-[#2a276e] hover:text-[#2a276e] font-medium"
                    >
                      Edit Message
                    </button>
                    ...
                    <button
                      ...
                      className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors ${
                        msg.enabled ? 'bg-[#2a276e]' : 'bg-gray-300'
                      }`}
                    >
                      <span
            ...
            <div className="bg-gradient-to-r from-[#2a276e]50 to-emerald-50 border border-[#9B8CFF] rounded-lg p-4">
